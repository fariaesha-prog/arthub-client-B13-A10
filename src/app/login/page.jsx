...
// 1. Added useEffect to the React imports here!
import { useState, useEffect } from "react";
import Link from "next/link";
import { useRouter } from "next/navigation";
// 2. Added Next.js Script component to fetch Google's library
...
export default function LoginPage() {
  ...
  const handleGoogleCallback = async (response) => {
    ...
    setLoading(true);
    try {
      // Send the ID token credential straight to your custom Express backend endpoint
  ...
  return (
    <main className="w-full min-h-[90vh] bg-[#0b0f1a] text-white flex items-center justify-center px-4 py-12 relative overflow-hidden">
      {/* 3. This script injects Google's infrastructure into your page asynchronously */}
      <Script 
      ...
      <div className="w-full max-w-md bg-[#111625] border border-white/5 rounded-2xl p-8 shadow-2xl relative z-10 backdrop-blur-sm">
        ...
        {/* 4. replaced old button with Google's direct iframe mount element container */}
